...
class DiaperAttach1View: SlideBaseView {
    ...
    override func setInit() {
        ...
        lblBottomTitle.text = "connection_monit_sensor_attaching_guide_cradle_title".localized
        lblBottomSummary.text = "connection_monit_sensor_attaching_guide_cradle_description".localized
    }
}
