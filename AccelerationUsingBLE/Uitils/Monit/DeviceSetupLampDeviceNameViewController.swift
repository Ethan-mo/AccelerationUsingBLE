//
//  DeviceSetupLampDeviceNameViewController.swift
//  Monit
//
...
class DeviceSetupLampDeviceNameViewController: BaseViewController {
    ...
    func setUI() {
        ...
        txtInput.text = lampStatusInfo!.m_name
    ...
    func receiveSetDeviceName(_ json: JSON) {
        ...
        switch receive.ecd {
        case .success:
            lampStatusInfo!.m_name = txtInput.text!
            UIManager.instance.sceneMoveNaviPop()
        default:
