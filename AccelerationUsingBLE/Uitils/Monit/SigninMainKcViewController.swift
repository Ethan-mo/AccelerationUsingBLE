...
class SigninMainKcViewController: BaseViewController {
    ...
    func setUI()
    {
        ...
        if (m_pwForm == nil) {
            ...
            m_pwForm!.setDefaultText(lblDefault: lblPw, defaultText: "signin_password".localized)
            m_pwForm!.m_encryptImgName = "imgDecryptBlack"
            m_pwForm!.m_decryptImgName = "imgEncryptBlack"
        }
    ...
    @IBAction func SetPawEditing(_ sender: UITextField) {
        m_pwForm?.editing()
    }
    ...
    @IBAction func onClick_findPw(_ sender: UIButton) {
