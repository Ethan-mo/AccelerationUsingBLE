...
class DeviceRegisterHubViewController: BaseViewController {
    ...
    @IBAction func onClick_connect(_ sender: UIButton) {
        ...
        if let _vc = UIManager.instance.sceneMoveNaviPush(scene: .deviceRegisterHubLight) as? DeviceRegisterHubLightViewController {
