...
class LampWifiCustomView: UIView, UITextFieldDelegate {
    ...
    func setUI() {
        ...
        lblSummary.text = "connection_lamp_select_ap_detail_etc".localized
    ...
    @IBAction func onClick_secu(_ sender: UIButton) {
        if let _view = UIManager.instance.sceneMoveNaviPush(scene: .deviceRegisterLampWifiCustomSecu) as? DeviceRegisterLampWifiCustomSecuViewController {
